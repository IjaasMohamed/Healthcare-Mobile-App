...
public final class ActivityAddTipsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAddTipsBinding(@NonNull ScrollView rootView, @NonNull Button btnAddCourse,
      @NonNull TextInputEditText etCourseDescription, @NonNull TextInputEditText etCourseImageLink,
      @NonNull TextInputEditText etCourseLink, @NonNull TextInputEditText etCourseName,
      @NonNull TextInputEditText etCourseSuitedFor, @NonNull ProgressBar progressBar) {
  ...
  @NonNull
  public static ActivityAddTipsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAddTipsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_add_tips, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAddTipsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddTipsBinding((ScrollView) rootView, btnAddCourse, etCourseDescription,
          etCourseImageLink, etCourseLink, etCourseName, etCourseSuitedFor, progressBar);
    }
